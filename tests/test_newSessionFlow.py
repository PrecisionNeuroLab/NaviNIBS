...
@pytest.mark.asyncio
@pytest.mark.order(after='test_planFiducials')
async def test_setTargets(navigatorGUIWithoutSession: NavigatorGUI,
    ...
    sessionPath = copySessionFolder(workingDir, 'PlanFiducials', 'SetTargets')
...
async def test_setTools(navigatorGUIWithoutSession: NavigatorGUI,
    ...
    sessionPath = copySessionFolder(workingDir, 'SetTargets', 'SetTools')
