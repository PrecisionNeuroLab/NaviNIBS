...
class Session:
    ...
    def __attrs_post_init__(self):
        ...
        self.subjectRegistration.sigSampledHeadPointsChanged.connect(lambda *args: self.flagKeyAsDirty('subjectRegistration'))
        ...
        self.coordinateSystems.sigCoordinateSystemsChanged.connect(self._onCoordinateSystemsChanged)
    ...
    def _onCoordinateSystemsChanged(self, keys: list[str]):
