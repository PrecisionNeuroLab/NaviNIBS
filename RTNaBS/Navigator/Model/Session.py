...
class Session:
    ...
    def __attrs_post_init__(self):
        ...
        self.subjectRegistration.fiducials.sigItemsChanged.connect(lambda: self.flagKeyAsDirty('subjectRegistration'))
        ...
        self.tools.sigItemsChanged.connect(lambda toolKeys: self.flagKeyAsDirty('tools'))
