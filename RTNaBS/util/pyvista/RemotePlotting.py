...
class _RemotePlotManager:
    ...
    def initPlotter(self):
        ...
        self._plotter = _RemotePlotter(*self._plotterArgs,
    ...
    def _callActorMethod(self, actor: ActorRef, msg):
        ...
        self._plotter._renderNow()  # TODO: debug, delete
...
class _RemotePlotter(BackgroundPlotter):
    def __init__(self, *args, **kwargs):
        BackgroundPlotter.__init__(self, *args,
                                   #off_screen=True,  # TODO: debug, delete
                                   **kwargs)
...
class _RemotePlotterApp(RunnableAsApp):
    ...
    _plotterKwargs: dict = attrs.field(factory=dict)
    _appLogEveryNLoops: tp.Optional[int] = 1  # TODO: debug, delete
    ...
    def __attrs_post_init__(self):
        ...
        self._debugTimer = QtCore.QTimer()
        self._debugTimer.setInterval(1)
        self._debugTimer.timeout.connect(self._debugTimerTimeout)
        self._debugTimer.start()

    def _debugTimerTimeout(self):
